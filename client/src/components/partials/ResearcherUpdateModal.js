...
import { updateUser } from "../../actions/researcherActions";
...
class ResearcherUpdateModal extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            password: '',
            contactno: this.props.record.contactno,
            errors: {},
        };
    }
    ...
    componentWillReceiveProps(nextProps) {
        if (nextProps.record) {
            this.setState({
                ...
                contactno: nextProps.record.contactno,
            })
        }
        if (nextProps.errors) {
            this.setState({
    ...
    onChange = e => {
        ...
        if (e.target.id === 'user-update-contactno') {
                    ...
                    <div className="modal-dialog modal-lg">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h4 className="modal-title">Update Researcher</h4>
...
ResearcherUpdateModal.propTypes = {
...
export default connect(
    mapStateToProps,
    { updateUser }
)(withRouter(ResearcherUpdateModal));
